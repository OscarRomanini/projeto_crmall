...
-- Copiando dados para a tabela crmall.clientes: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `clientes` DISABLE KEYS */;
INSERT INTO `clientes` (`id`, `nome`, `nasc`, `sexo`, `cep`, `endereco`, `num`, `complemento`, `bairro`, `estado`, `cidade`) VALUES
	(26, 'Oscar Edson Romanini Junior', '27/04/1995', 'M', '87013210', 'Avenida Tamandaré', 655, 'ap 43', 'Zona 01', 'PR', 'Maringá ');
...
-- Copiando dados para a tabela crmall.usuarios: ~1 rows (aproximadamente)
